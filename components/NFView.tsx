...
const NFView: React.FC<Props> = ({ customersPF, customersPJ, financials, notify }) => {
  ...
  const [formData, setFormData] = useState({
    // Emitente (Dados Fixos Adriana Reciclagem)
  ...
  // 1. Lógica de Auto-completar Cliente por CPF ou CNPJ
  useEffect(() => {
  ...
  // 2. Lógica para calcular o Valor Total da Nota automaticamente
  useEffect(() => {
  ...
  // 3. Lógica de Envio para a API do Servidor
  const handleTransmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        throw new Error(result.error || "Erro na transmissão da SEFAZ");
      }
    } catch (error: any) {
      console.error(error);
      alert("Falha na Emissão: " + error.message);
    } finally {
      setLoading(false);
    }
  };
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div className="md:col-span-1">
                ...
                <div className="flex bg-slate-100 p-1 rounded-xl">
                  <button 
                    type="button"
                    onClick={() => { setRecipientType('CNPJ'); setDocNumber(''); }}
                  ...
                  <button 
                    type="button"
                    onClick={() => { setRecipientType('CPF'); setDocNumber(''); }}
              ...
              <div className="md:col-span-2">
                ...
                <input 
                  ...
                  onChange={(e) => setFormData({...formData, destName: e.target.value.toUpperCase()})}
                  required
                  className="w-full p-4 bg-slate-50 rounded-2xl font-bold border-none focus:ring-2 focus:ring-emerald-500 outline-none" 
                />
              </div>
              <div className="md:col-span-1">
                ...
                <input 
                  ...
                  onChange={(e) => setFormData({...formData, destIE: e.target.value.toUpperCase()})}
                  placeholder="Isento"
                  className="w-full p-4 bg-slate-50 rounded-2xl font-bold border-none focus:ring-2 focus:ring-emerald-500 outline-none" 
                />
              </div>
              <div className="md:col-span-3">
                ...
                <input 
                  ...
                  onChange={(e) => setFormData({...formData, destAddress: e.target.value.toUpperCase()})}
                  required
                  className="w-full p-4 bg-slate-50 rounded-2xl font-bold border-none focus:ring-2 focus:ring-emerald-500 outline-none" 
                />
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <select 
                  ...
                  className="w-full p-4 bg-slate-50 rounded-2xl font-bold border-none focus:ring-2 focus:ring-amber-500 outline-none cursor-pointer"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div className="md:col-span-2">
                ...
                <input 
                  ...
                  onChange={(e) => setFormData({...formData, prodDesc: e.target.value.toUpperCase()})}
              ...
              <div className="md:col-span-2">
                ...
                <select 
                  ...
                  required
                  className="w-full p-4 bg-slate-50 rounded-2xl font-bold border-none focus:ring-2 focus:ring-blue-500 outline-none cursor-pointer"
                >
              ...
              <div>
                ...
                <input 
                  readOnly
                  value={formatCurrency(Number(formData.qty) * Number(formData.unitValue))}
            ...
            {formData.isHazardous && (
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6 animate-in fade-in slide-in-from-top-4">
                <div>
                  ...
                  <input 
                    value={formData.mtr}
                    onChange={(e) => setFormData({...formData, mtr: e.target.value.toUpperCase()})}
                ...
                <div>
                  ...
                  <input 
                    ...
                    onChange={(e) => setFormData({...formData, cadri: e.target.value.toUpperCase()})}
                    className="w-full p-4 bg-slate-50 rounded-2xl font-bold border-none focus:ring-2 focus:ring-indigo-500 outline-none" 
                  />
                </div>
                <div>
                  ...
                  <input 
                    ...
                    onChange={(e) => setFormData({...formData, riskClass: e.target.value.toUpperCase()})}
                    className="w-full p-4 bg-slate-50 rounded-2xl font-bold border-none focus:ring-2 focus:ring-indigo-500 outline-none" 
                  />
                </div>
                <div>
                  ...
                  <input 
                    ...
                    onChange={(e) => setFormData({...formData, onuNumber: e.target.value.toUpperCase()})}
                    className="w-full p-4 bg-slate-50 rounded-2xl font-bold border-none focus:ring-2 focus:ring-indigo-500 outline-none" 
                  />
                </div>
                <div className="md:col-span-2">
                  ...
                  <input 
                    ...
                    onChange={(e) => setFormData({...formData, shippingName: e.target.value.toUpperCase()})}
                    className="w-full p-4 bg-slate-50 rounded-2xl font-bold border-none focus:ring-2 focus:ring-indigo-500 outline-none" 
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <input 
                    value={formData.antt}
                    onChange={(e) => setFormData({...formData, antt: e.target.value.toUpperCase()})}
                    className="w-full p-4 bg-slate-50 rounded-2xl font-bold border-none focus:ring-2 focus:ring-indigo-500 outline-none" 
                  />
                </div>
              </div>
